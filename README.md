...
```bash
git clone https://github.com/actionanand/angular-parcel-app.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/angular-parcel-app#1-skeleton angular-proj-name
```
